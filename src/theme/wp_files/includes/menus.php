...
function ci_create_custom_menus()
{
    if (function_exists('acf_add_options_page')) {
        ...
        acf_add_options_page(array(
            'page_title'     => __('Options Générales', '@@themeName'),
            'menu_title'     => __('Options Générales', '@@themeName'),
            'menu_slug'     => 'general-options',
            'update_button' => __('Mettre à jour', '@@themeName'),
            'updated_message' => __('Options mise à jour', '@@themeName'),
        ));
    }
}
...
function ci_register_menus()
{
    ...
    register_nav_menus(array(
        ...
        'footer-main-nav'             => __('Menu pied de page', '@@themeName'),
        'footer-secondary-nav'        => __('Menu pied de page secondaire', '@@themeName'),
    ));
}
