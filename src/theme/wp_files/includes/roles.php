...
function roles_widget_function() {
    ...
    echo '<strong>'.__('Rôles enregistrés sur le site : ', '@@themeName').'</strong>';
    ...
    submit_button(__('Mettre à jour les rôles', '@@themeName'));

    echo '</form>';

    echo '<p>'.__('Mettre à jour supprime les rôles de bases.<br>Les rôles et capability sont modifiables dans <em>includes/roles.php</em>', '@@themeName').'</p>';
